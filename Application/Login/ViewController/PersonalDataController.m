...
- (void)viewDidLoad {
    ...
    _employeeMangeCell.backgroundColor = [UIColor clearColor];
    _flowRecordCell.backgroundColor = [UIColor clearColor];
    _feadBcakCell.backgroundColor = [UIColor clearColor];
    _settingCell.backgroundColor = [UIColor clearColor];
