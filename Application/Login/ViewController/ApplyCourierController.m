...
- (void)addConfirmViewAtBottom
{
    ...
    [_check2 setTitle:@"同意并接受《乐点申请协议》" forState:UIControlStateNormal];
...
- (void)exitBtnClick
{
    ...
    [params setObject:self.userNameLabel.text forKey:@"name"];
    [params setObject:self.IDCardLabel.text forKey:@"id_num"];

    
    [[HttpProtocolAPI sharedClient] authForStore:params images:self.imagesArray setBlock:^(NSDictionary *data, NSError *error) {
