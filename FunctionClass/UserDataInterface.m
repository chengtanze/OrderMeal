...
-(NSString *)userID{
    return (_dicUserInfo != nil ? [_dicUserInfo valueForKey:@"u_id"] : @"");
}

-(NSInteger)userID_Int
{
    return (_dicUserInfo != nil ? [[_dicUserInfo valueForKey:@"u_id"] integerValue] : -1);
}
...
-(NSString *)storeID{
    return (_dicUserInfo != nil ? [_dicUserInfo valueForKey:@"store_id"] : @"");
}

-(NSInteger)storeID_Int{
    return [self.storeID integerValue];
}
