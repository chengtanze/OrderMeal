...
_goStatic._TEMPLATE._THUMB=T(['<div class="$normal$" un="item" param="$value$"','onmouseover="','this.getAttribute(\x27select\x27)!=\x27true\x27&&getTop().setClass(this,\x27$over$\x27);','" onmouseout="','this.getAttribute(\x27select\x27)!=\x27true\x27&&getTop().setClass(this,\x27$normal$\x27);','">','<img class="$img$" src="$images_path$webp/$url$" param="$value$"/>','</div>']);
_goStatic._TEMPLATE._MSG=T(['<div style="text-align:center;">','<img src="$images_path$webp/ico_loading11e9c5d.gif" style="display:$dispload$;"/>','$msg$','</div>']);
...
if(e.sms)
{
loadJsFileToTop(["$js_path$webp/qmtip270d91.js"]);
var Q=this._moWin;
waitFor(function(){
return QMTip;
},function(V){
...
var l="\u8BBE\u4E3A\u5783\u573E\u90AE\u4EF6\u6210\u529F",g=0,m=unikey('spam'),j=a.oMail,f=0,h=0,e=false,k=['mailaction=mail_spam&isspam=true'],d;
switch(c)
{case "readmail_spam":
case "readmail_spam_newwin":
if(a.sFid==6)
{
l="\u4E3E\u62A5\u6210\u529F\uFF0C\u90AE\u4EF6\u5DF2\u7ECF\u5F7B\u5E95\u5220\u9664\uFF0C\u611F\u8C22\u60A8\u5BF9QQ\u90AE\u7BB1\u53CD\u5783\u573E\u90AE\u4EF6\u5DE5\u4F5C\u7684\u652F\u6301";
}
else{
l=['\u4E3E\u62A5\u6210\u529F\u3002\u5DF2\u5C06\u90AE\u4EF6\u6210\u529F\u79FB\u5165\u5783\u573E\u7BB1 <a style="color:white" href="/cgi-bin/mail_list?sid=',getSid(),'&folderid=6&page=0" target="mainFrame" onclick="gotoCheckRejectEmail();">[\u67E5\u770B]</a>'].join("");
h=10000;
}
break;
case "readmail_reject":
case "readmail_reject_newwin":
l=(a.sFid==6?"\u4E3E\u62A5\u6210\u529F\uFF0C\u5E76\u5C06\u6B64\u53D1\u4EF6\u4EBA\u6DFB\u52A0\u5230\u9ED1\u540D\u5355":"\u5DF2\u5C06\u6B64\u53D1\u4EF6\u4EBA\u6DFB\u52A0\u5230\u9ED1\u540D\u5355\uFF0C\u5E76\u5C06\u8BE5\u90AE\u4EF6\u79FB\u5165\u5783\u573E\u90AE\u4EF6\u7BB1");
break;
case "readmail_group":
...
{
e=e||j[n].bSys;
f+=j[n].bUnr?getMLMailItemUnreadNum.getNum(j[n]):0;
}
showInfo('\u90AE\u4EF6\u4E3E\u62A5\u4E2D...',-1);
a.oWin[m]=1;
...
AjaxSendMailMgr({oQuery:b,sSuccessMask:'spam successful',sDefErrMsg:'\u4E3E\u62A5\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5',onload:function(o,q,p){
var u=o.url,r=callBack(a.oncomplete,[a,o]);
!(d&&r)&&showInfo(l,h);
if(u&&!r&&a.oWin[m])
{
dealRmMailJump(a,o);
if(!o.nodlg&&o.showReportInfo)
{
o.showReportInfo(o.reportCnt,o.acceptCnt,o.allCnt,o.trushCnt);
}
}
else if(a.bML&&!o.nodlg&&getTop().QMTip&&a.oWin[m])
{
var s=10002;
o.sid=getSid();
o.tipid=s;
var t=TE(["<p>\u60A8\u603B\u5171\u4E3E\u62A5\u4E86 $reportCnt$ \u6B21</p>","<p style='font-weight:normal;'>$@$if($acceptCnt$)$@$\u88AB\u7CFB\u7EDF\u91C7\u7EB3\u4E86 $acceptCnt$ \u6B21<br/>$@$endif$@$\u4ECA\u5929\u6211\u4EEC\u7CFB\u7EDF\u6536\u5230 $allCnt$ \u6B21\u4E3E\u62A5<br/>\u603B\u5171\u62E6\u622A\u4E86 $trushCnt$ \u5C01\u5783\u573E\u90AE\u4EF6<br/>\u611F\u8C22\u60A8\u5BF9QQ\u90AE\u7BB1\u53CD\u5783\u573E\u5DE5\u4F5C\u7684\u652F\u6301\uFF01","<div style=''></div>","<div style='text-align:right;font-weight:normal;'><a onclick=\"javascript: getTop().goUrlMainFrm('/cgi-bin/help_report_spam?sid=$sid$', false);getTop().QMTip.close('', $tipid$, false, true);\" style='text-decoration:underline;'>\u4E3E\u62A5\u6570\u636E\u4E2D\u5FC3</a>&nbsp;<a href='javascript;' onclick='getTop().runUrlWithSid(\"/cgi-bin/help_report_spam?type=0&ixspaminfo=1\");getTop().QMTip.close(\"\", $tipid$, false, true);return false;' style='text-decoration:underline;'>\u4EE5\u540E\u4E0D\u518D\u63D0\u793A</a></div>"]).replace(o);
QMTip.show2({bForceShow:true,type:4,win:a.oWin,tipid:s,domid:"gotnomail",msg:t,arrow_direction:"none",arrow_offset:0,width:400,height_offset:150,tip_offset:-300,close_fork:1});
}
{
reloadLeftWin();
setRollBack(o.rbkey,"\u4E3E\u62A5\u90AE\u4EF6");
}
}});
};
...
var l=g.sFlashUrl||a.getRes("$swf_path$uploader28968f.swf");
...
o.setSendEmptyPackage&&o.setSendEmptyPackage(a.isBrowser('chrome')&&n.get('nSize')>100*1024*1024);
