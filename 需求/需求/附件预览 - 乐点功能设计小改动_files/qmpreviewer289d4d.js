...
if(!g[h])
{
g.loadJsFileToTop(["$js_path$webp/qmplayer/player289cd9.js"]);
}
g.waitFor(function(){
return !!g[h];
},function(i){
...
a.S(this._msId+"_downframe").src=(p||this._moCurViewer.getFileInfo()).sDown;
}
break;
case "select":
